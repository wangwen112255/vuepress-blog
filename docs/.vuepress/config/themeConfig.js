...
module.exports = {
  ...
  repo: 'https://github.com/wangwen112255', // 导航栏右侧生成Github链接
  ...
  wordsPerMinute: 200, // 每分钟阅读的字数 默认是 300
  ...
  author: {
    ...
    name: '窝窝侠', // 必需
    link: 'https://github.com/wangwen112255', // 可选的
  },
  blogger: {
    // 博主信息，显示在首页侧边栏
  ...
  //   copyrightInfo:
  //     '小胖墩er | <a href="https://github.com/wangwen112255/blog/blob/master/LICENSE" target="_blank">MIT License</a> <br/> <font style="color: #666"> <a href="https://beian.miit.gov.cn" target="_blank">粤ICP备2021158933号</a> </font>', // 博客版权信息，支持a标签
  // },
